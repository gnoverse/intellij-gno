...
import com.github.intellij.gno.appengine.GoAppEngineIcons;
import com.github.intellij.gno.runconfig.GoConfigurationFactoryBase;
...
public class GoAppEngineRunConfigurationType extends ConfigurationTypeBase {
  ...
  public static GoAppEngineRunConfigurationType getInstance() {
    return CONFIGURATION_TYPE_EP.findExtensionOrFail(GoAppEngineRunConfigurationType.class);
  }
}