...
public interface GoIcons {
  Icon ICON = IconLoader.findIcon("/icon/gno-icon.svg");
  Icon TYPE = IconLoader.findIcon("/icon/gno-icon.svg");
  ...
  Icon CONSTANT = IconLoader.findIcon("/icon/gno-icon.svg");
  ...
  Icon MODULE_ICON = IconLoader.findIcon("/icon/gno-icon.svg");
