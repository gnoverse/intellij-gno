...
package com.github.intellij.gno.runconfig.testing.frameworks.gotest;

import com.github.intellij.gno.GoConstants;
import com.github.intellij.gno.generate.GoGenerateTestActionBase;
import com.github.intellij.gno.psi.GoFile;
import com.github.intellij.gno.psi.GoImportSpec;
import com.github.intellij.gno.psi.impl.GoPsiImplUtil;
import com.github.intellij.gno.runconfig.testing.GoTestFunctionType;
import com.github.intellij.gno.template.GoLiveTemplateContextType;
...
public class GotestGenerateAction extends GoGenerateTestActionBase {
  ...
  protected boolean isValidForFile(@NotNull Project project, @NotNull Editor editor, @NotNull PsiFile file) {
    GoLiveTemplateContextType.File fileContextType = new GoLiveTemplateContextType.File();
    return fileContextType.isInContext(file, editor.getCaretModel().getOffset());
  }
