...
public abstract class GoRunConfigurationBase<RunningState extends GoRunningState>
  extends ModuleBasedConfiguration<GoModuleBasedConfiguration, GoRunConfigurationBase<RunningState>> implements RunConfigurationWithSuppressedDefaultRunAction,
  ...
  public GoRunConfigurationBase(String name, GoModuleBasedConfiguration<GoRunningState> configurationModule, ConfigurationFactory factory) {
  ...
  public void checkConfiguration() throws RuntimeConfigurationException {
    GoModuleBasedConfiguration<GoRunningState> configurationModule = getConfigurationModule();
    Module module = configurationModule.getModule();
    if (module != null) {
  ...
  private RunningState createRunningState(ExecutionEnvironment env) throws ExecutionException {
    GoModuleBasedConfiguration<GoRunningState> configuration = getConfigurationModule();
