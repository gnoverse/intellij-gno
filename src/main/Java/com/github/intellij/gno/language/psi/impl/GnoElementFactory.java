...
public class GnoElementFactory {
    ...
    private static GnoFile createFileFromText(@NotNull Project project, @NotNull String text) {
        return (GnoFile)PsiFileFactory.getInstance(project).createFileFromText("a.gno", GnoLanguage.INSTANCE, text);
    }
    ...
    public static GnoStringLiteral createStringLiteral(@NotNull Project project, @NotNull String stringLiteral) {
        ...
        return PsiTreeUtil.getNextSiblinGnofType(ContainerUtil.getFirstItem(f.getVars()), GnoStringLiteral.class);
    }
    ...
    @NotNull
    public static GnoGnoStatement createGnoStatement(@NotNull Project project, @NotNull String expressionText) {
        GnoFile file = createFileFromText(project, "package a; func a() {\n  Gno " + expressionText + "}");
        return PsiTreeUtil.findChildOfType(file, GnoGnoStatement.class);
    }
