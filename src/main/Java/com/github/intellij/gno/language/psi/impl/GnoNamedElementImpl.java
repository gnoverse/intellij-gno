...
import com.github.intellij.gno.language.project.GnoVendoringUtil;
import com.github.intellij.gno.language.psi.*;
import com.github.intellij.gno.language.sdk.GnoPackageUtil;
import com.github.intellij.gno.language.stubs.GnoNamedStub;
import com.github.intellij.gno.language.util.GnoUtil;
...
public abstract class GnoNamedElementImpl<T extends GnoNamedStub<?>> extends GnoStubbedElementImpl<T> implements GnoCompositeElement, GnoNamedElement {
    ...
    public Icon getIcon(int flags) {
        Icon icon = null;
        if (this instanceof GnoMethodDeclaration) icon = GnoIcon.METHOD;
        else if (this instanceof GnoFunctionDeclaration) icon = GnoIcon.FUNCTION;
        else if (this instanceof GnoTypeSpec) icon = GnoIcon.TYPE;
        else if (this instanceof GnoVarDefinition) icon = GnoIcon.VARIABLE;
        else if (this instanceof GnoConstDefinition) icon = GnoIcon.CONSTANT;
        else if (this instanceof GnoFieldDefinition) icon = GnoIcon.FIELD;
        else if (this instanceof GnoMethodSpec) icon = GnoIcon.METHOD;
        else if (this instanceof GnoAnonymousFieldDefinition) icon = GnoIcon.FIELD;
        else if (this instanceof GnoParamDefinition) icon = GnoIcon.PARAMETER;
        else if (this instanceof GnoLabelDefinition) icon = GnoIcon.LABEL;
        if (icon != null) {
