...
import com.github.intellij.gno.language.stubs.GnoFileStub;
...
public class GnoFile extends PsiFileBase {
    ...
    public GlobalSearchScope getResolveScope() {
        return GnoUtil.gnoPathResolveScope(this);
    }

    @NotNull
    @Override
    public SearchScope getUseScope() {
        return GnoUtil.gnoPathUseScope(this, true);
    }
    ...
    public List<GnoFunctionDeclaration> getFunctions() {
        return CachedValuesManager.getCachedValue(this, () -> {
            ...
            List<GnoFunctionDeclaration> functions = stub != null
                    ...
                    : GnoPsiImplUtil.gnoTraverser().children(this).filter(GnoFunctionDeclaration.class).toList();
    ...
    public List<GnoMethodDeclaration> getMethods() {
        return CachedValuesManager.getCachedValue(this, () -> {
            ...
            List<GnoMethodDeclaration> calc = stub != null
                    ...
                    : GnoPsiImplUtil.gnoTraverser().children(this).filter(GnoMethodDeclaration.class).toList();
    ...
    private List<GnoTypespec> calcTypes() {
        return GnoPsiImplUtil.gnoTraverser().children(this).filter(GnoTypeDeclaration.class).flatten(GnoTypeDeclaration::getTypeSpecList).toList();
    }
    ...
    private List<GnoVarDefinition> calcVars() {
        return GnoPsiImplUtil.gnoTraverser().children(this).filter(GnoVarDeclaration.class)
    ...
    private List<GnoConstDefinition> calcConsts() {
        return GnoPsiImplUtil.gnoTraverser().children(this).filter(GnoConstDeclaration.class)
