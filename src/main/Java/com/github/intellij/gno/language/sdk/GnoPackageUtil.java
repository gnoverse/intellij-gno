...
import com.goide.project.GnoBuildTargetSettings;
import com.goide.project.GnoModuleSettings;
...
public class GnoPackageUtil {
    ...
    public static boolean isBuiltinPackage(@Nullable PsiFileSystemItem directory) {
        return directory instanceof PsiDirectory
                ...
                && GnoConstants.BUILTIN_PACKAGE_NAME.equals(com.github.intellij.gno.language.sdk.GnoSdkUtil.getImportPath((PsiDirectory)directory, false));
    }
    ...
    public static VirtualFile findByImportPath(@NotNull String importPath, @NotNull Project project, @Nullable Module module) {
        ...
        for (VirtualFile root : com.github.intellij.gno.language.sdk.GnoSdkUtil.getSourcesPathsToLookup(project, module)) {
