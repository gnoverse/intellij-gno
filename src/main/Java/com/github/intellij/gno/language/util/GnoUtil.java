...
import com.github.intellij.gno.language.project.GnoExcludedPathsSettings;
...
public class GnoUtil {
    ...
    public static String systemArch() {
        ...
        if (SystemInfo.isWindows) {
            ...
            return arch.endsWith("64") || wow64Arch != null && wow64Arch.endsWith("64") ? GnoConstants.AMD64 : "386";
        }
