...
public class GnoConstants {
    ...
    public static final String GNO_VENDORING_EXPERIMENT = "GO15VENDOREXPERIMENT";
    public static final String GNO_LIBRARIES_SERVICE_NAME = "GoLibraries";
    ...
    @NonNls public static final String GNO_EXECUTABLE_NAME = "gno";
