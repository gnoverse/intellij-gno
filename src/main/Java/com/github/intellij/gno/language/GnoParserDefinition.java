...
import com.github.intellij.gno.language.lexer.GnoLexer;
import com.github.intellij.gno.language.parser.GnoParser;
...
import static com.github.intellij.gno.language.GnoConstants.GNO;
...
public class GnoParserDefinition implements ParserDefinition {
    ...
    public static final IElementType GNO = new IElementType("gno", GnoLanguage.INSTANCE);
