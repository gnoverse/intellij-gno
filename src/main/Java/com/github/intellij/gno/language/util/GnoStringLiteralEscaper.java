package com.github.intellij.gno.language.util;

import com.github.intellij.gno.language.psi.GnoStringLiteral;
...
public class GnoStringLiteralEscaper extends LiteralTextEscaper<GnoStringLiteral> {

    private int[] outSourceOffsets;

    public GnoStringLiteralEscaper(@NotNull GnoStringLiteral host) {
        super(host);
    }
    ...
    /**
     * Escapes the specified string in accordance with <a href="https://golang.org/ref/spec#Rune_literals"></a>
     */
