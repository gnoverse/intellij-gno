...
import com.github.intellij.gno.configuration.GoConfigurableProvider;
import com.github.intellij.gno.configuration.GoModuleSettingsConfigurable;
...
@State(name = GoConstants.GO_MODULE_SESTTINGS_SERVICE_NAME, storages = @Storage(value = StoragePathMacros.MODULE_FILE))
