...
import com.github.intellij.gno.project.GoBuildTargetSettings;
...
public class GoBuildTagsSettingsConverterProvider extends ConverterProvider {
  ...
  public ProjectConverter createConverter(@NotNull ConversionContext context) {
    return new ProjectConverter() {
      ...
      @NotNull
      private File getGoBuildFlagsFile() {return new File(String.valueOf(context.getSettingsBaseDir()), "goBuildFlags.xml");}
      ...
      public void preProcessingFinished() throws CannotConvertException {
        ...
        if (oldSettingsFile.exists()) {
          Element oldSettingsRoot = JDomConvertingUtil.load(oldSettingsFile.toPath());
