...
public class GnoFieldLiteralImpl extends ASTWrapperPsiElement implements GnoFieldLiteral {

  public GnoFieldLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GnoVisitor visitor) {
    visitor.visitFieldLiteral(this);
  }
