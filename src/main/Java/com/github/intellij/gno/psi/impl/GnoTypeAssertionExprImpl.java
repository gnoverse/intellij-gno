...
public class GnoTypeAssertionExprImpl extends GnoExpressionImpl implements GnoTypeAssertionExpr {

  public GnoTypeAssertionExprImpl(ASTNode node) {
    super(node);
  }
  ...
  public GnoType getType() {
    return notNullChild(GnoPsiTreeUtil.getChildOfType(this, GnoType.class));
  }
