...
public class GnoQualifiedIdentifierImpl extends ASTWrapperPsiElement implements GnoQualifiedIdentifier {

  public GnoQualifiedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
