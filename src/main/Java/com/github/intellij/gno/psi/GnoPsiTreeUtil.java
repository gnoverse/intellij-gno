...
public class GnoPsiTreeUtil extends PsiTreeUtil {
  @Nullable
  ...
  @Nullable
  private static Couple<PsiElement> getElementRange(@NotNull GnoFile file, int startOffset, int endOffset) {
  ...
  @NotNull
  public static PsiElement[] getTopLevelElementsInRange(@NotNull GnoFile file,
                                                        int startOffset,
                                                        int endOffset,
  ...
  @Nullable
  private static PsiElement findNotWhiteSpaceElementAtOffset(@NotNull GnoFile file, int offset, boolean forward) {
