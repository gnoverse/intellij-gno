...
public class GnoIfStatementImpl extends ASTWrapperPsiElement implements GnoIfStatement {

  public GnoIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GnoBlock> getBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GnoBlock.class);
  }
