...
public class GnoCompositeLitImpl extends GnoExpressionImpl implements GnoCompositeLit {

  public GnoCompositeLitImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GnoLiteralValue getLiteralValue() {
    return GnoPsiTreeUtil.getChildOfType(this, GnoLiteralValue.class);
  }
