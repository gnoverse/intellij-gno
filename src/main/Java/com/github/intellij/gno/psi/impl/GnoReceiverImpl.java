...
public class GnoReceiverImpl extends GnoNamedElementImpl<GnoReceiverStub> implements GnoReceiver {

  public GnoReceiverImpl(GnoReceiverStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoReceiverImpl(ASTNode node) {
    super(node);
  }
