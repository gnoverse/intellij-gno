...
public class GnoFunctionLitImpl extends GnoExpressionImpl implements GnoFunctionLit {

  public GnoFunctionLitImpl(ASTNode node) {
    super(node);
  }
  ...
  public GnoSignature getSignature() {
    return GnoPsiTreeUtil.getChildOfType(this, GnoSignature.class);
  }
