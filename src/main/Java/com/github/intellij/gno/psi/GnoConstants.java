...
public class GnoConstants {
    public static final String MODULE_TYPE_ID = "GNO_MODULE";
    public static final String SDK_TYPE_ID = "Gno SDK";
    public static final String PATH = "PATH";
    public static final String GNO_PATH = "GNOPATH";
    public static final String GNO_ROOT = "GNOROOT";
    public static final String GNO_VENDORING_EXPERIMENT = "GNO15VENDOREXPERIMENT";
    public static final String GNO_LIBRARIES_SERVICE_NAME = "GnoLibraries";
    public static final String GNO_LIBRARIES_CONFIG_FILE = "goLibraries.xml";
    public static final String GNO_MODULE_SESTTINGS_SERVICE_NAME = "Gno";
    ...
    @NonNls public static final String GNO_VERSION_FILE_PATH = "runtime/zversion.go";
    @NonNls public static final String GNO_VERSION_NEW_FILE_PATH = "runtime/internal/sys/zversion.go";
    ...
    @NonNls public static final String APP_ENGINE_GNO_ROOT_DIRECTORY_PATH = "/goroot";
    ...
    @NonNls public static final String GNO_EXECUTABLE_NAME = "go";
    public static final String BUILD_FLAG = "+build";

    public static final String LINUX_OS = "linux";
    public static final String ANDROID_OS = "android";

    // see "$GNOROOT/src/go/build/syslist.go
    ...
    public static final Set<String> KNOWN_CGNO = ContainerUtil.immutableSet("darwin/386", "darwin/amd64", "dragonfly/386", "dragonfly/amd64",
    ...
    @NonNls public static final String GNO = "Gno";
    @NonNls public static final String AMD64 = "amd64";

    private GnoConstants() {
