...
public class GnoExprSwitchStatementImpl extends GnoSwitchStatementImpl implements GnoExprSwitchStatement {

  public GnoExprSwitchStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GnoExprCaseClause> getExprCaseClauseList() {
    return GnoPsiTreeUtil.getChildrenOfTypeAsList(this, GnoExprCaseClause.class);
  }
