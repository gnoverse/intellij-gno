...
public class GnoImportReferenceSet extends FileReferenceSet {
  public GnoImportReferenceSet(@NotNull GnoImportString importString) {
  ...
  public Collection<PsiFileSystemItem> computeDefaultContexts() {
    ...
    LinkedHashSet<VirtualFile> sourceRoots = GnoVendoringUtil.isVendoringEnabled(module)
                                             ? GnoSdkUtil.getVendoringAwareSourcesPathsToLookup(project, module, file.getVirtualFile())
  ...
  public FileReference createFileReference(TextRange range, int index, String text) {
    return new GnoImportReference(this, range, index, text);
  }
