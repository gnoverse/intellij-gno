...
public class GnoVarDefinitionImpl extends GnoNamedElementImpl<GnoVarDefinitionStub> implements GnoVarDefinition {

  public GnoVarDefinitionImpl(GnoVarDefinitionStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoVarDefinitionImpl(ASTNode node) {
    super(node);
  }
