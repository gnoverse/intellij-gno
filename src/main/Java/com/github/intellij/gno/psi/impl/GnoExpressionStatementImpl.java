...
public class GnoExpressionStatementImpl extends ASTWrapperPsiElement implements GnoExpressionStatement {

  public GnoExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
