...
public class GnoCallExprImpl extends GnoExpressionImpl implements GnoCallExpr {

  public GnoCallExprImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GnoArgumentList getArgumentList() {
    return notNullChild(GnoPsiTreeUtil.getChildOfType(this, GnoArgumentList.class));
  }
