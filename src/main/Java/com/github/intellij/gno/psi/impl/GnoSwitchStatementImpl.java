...
public class GnoSwitchStatementImpl extends ASTWrapperPsiElement implements GnoSwitchStatement {

  public GnoSwitchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GnoCaseClauses getCaseClauses() {
    return findNotNullChildByClass(GnoCaseClauses.class);
  }
