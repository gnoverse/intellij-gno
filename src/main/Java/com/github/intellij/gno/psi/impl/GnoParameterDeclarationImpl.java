...
public class GnoParameterDeclarationImpl extends ASTWrapperPsiElement implements GnoParameterDeclaration {

  public GnoParameterDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
