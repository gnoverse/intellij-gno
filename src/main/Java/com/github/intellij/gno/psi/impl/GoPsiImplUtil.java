...
import com.github.intellij.gno.psi.impl.imports.GoImportReferenceSet;
...
import static com.github.intellij.gno.psi.impl.GoLightType.*;
...
public class GoPsiImplUtil {
  ...
  static boolean processNamedElements(@NotNull PsiScopeProcessor processor,
    ...
    //noinspection unchecked
    return processNamedElements(processor, state, elements, localResolve, checkContainingFile);
  }
