...
public class GnoKeyImpl extends GnoCompositeElementImpl implements GnoKey {

  public GnoKeyImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public GnoFieldName getFieldName() {
    return GnoPsiTreeUtil.getChildOfType(this, GnoFieldName.class);
  }
