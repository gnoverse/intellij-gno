...
//
//public class GnoStringManipulator extends AbstractElementManipulator<GnoStringLiteralImpl> {
//  @Override
//  public GnoStringLiteralImpl handleContentChange(@NotNull GnoStringLiteralImpl literal, @NotNull TextRange range, String newContent)
...
//  @NotNull
//  @Override
//  public TextRange getRangeInElement(@NotNull GnoStringLiteralImpl element) {
