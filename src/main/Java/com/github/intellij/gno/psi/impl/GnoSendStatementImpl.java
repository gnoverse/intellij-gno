...
public class GnoSendStatementImpl extends GnoStatementImpl implements GnoSendStatement {

  public GnoSendStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public GnoLeftHandExprList getLeftHandExprList() {
    return GnoPsiTreeUtil.getChildOfType(this, GnoLeftHandExprList.class);
  }
  ...
  @Nullable
  public GnoExpression getSendExpression() {
    return GnoPsiImplUtil.getSendExpression(this);
  }
