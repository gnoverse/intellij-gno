...
public class GnoSimpleStatementImpl extends GnoStatementImpl implements GnoSimpleStatement {

  public GnoSimpleStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public GnoShortVarDeclaration getShortVarDeclaration() {
    return GnoPsiTreeUtil.getChildOfType(this, GnoShortVarDeclaration.class);
  }
