...
public class GnoFieldDefinitionImpl extends GnoNamedElementImpl<GnoFieldDefinitionStub> implements GnoFieldDefinition {

  public GnoFieldDefinitionImpl(GnoFieldDefinitionStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoFieldDefinitionImpl(ASTNode node) {
    super(node);
  }
