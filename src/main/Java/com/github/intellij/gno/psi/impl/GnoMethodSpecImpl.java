...
public class GnoMethodSpecImpl extends GnoNamedElementImpl<GnoMethodSpecStub> implements GnoMethodSpec {

  public GnoMethodSpecImpl(GnoMethodSpecStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoMethodSpecImpl(ASTNode node) {
    super(node);
  }
