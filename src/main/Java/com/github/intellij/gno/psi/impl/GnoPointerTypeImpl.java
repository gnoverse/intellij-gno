...
public class GnoPointerTypeImpl extends GnoTypeImpl implements GnoPointerType {

  public GnoPointerTypeImpl(GnoTypeStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoPointerTypeImpl(ASTNode node) {
    super(node);
  }
