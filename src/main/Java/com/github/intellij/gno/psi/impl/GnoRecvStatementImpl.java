...
public class GnoRecvStatementImpl extends GnoVarSpecImpl implements GnoRecvStatement {

  public GnoRecvStatementImpl(GnoVarSpecStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoRecvStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Nullable
  public GnoExpression getRecvExpression() {
    return GnoPsiImplUtil.getRecvExpression(this);
  }

  @NotNull
  public List<GnoExpression> getLeftExpressionsList() {
    return GnoPsiImplUtil.getLeftExpressionsList(this);
  }
