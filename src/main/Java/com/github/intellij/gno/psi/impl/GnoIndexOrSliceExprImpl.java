...
public class GnoIndexOrSliceExprImpl extends GnoExpressionImpl implements GnoIndexOrSliceExpr {

  public GnoIndexOrSliceExprImpl(ASTNode node) {
    super(node);
  }
  ...
  public GnoExpression getExpression() {
    return GnoPsiImplUtil.getExpression(this);
  }

  @NotNull
  public Trinity<GnoExpression, GnoExpression, GnoExpression> getIndices() {
    return GnoPsiImplUtil.getIndices(this);
  }
