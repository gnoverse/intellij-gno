...
public class GnoLabelDefinitionImpl extends GnoNamedElementImpl<GnoLabelDefinitionStub> implements GnoLabelDefinition {

  public GnoLabelDefinitionImpl(GnoLabelDefinitionStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoLabelDefinitionImpl(ASTNode node) {
    super(node);
  }
