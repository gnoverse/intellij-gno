...
public class GnoAnonymousFieldDefinitionImpl extends GnoNamedElementImpl<GnoAnonymousFieldDefinitionStub> implements GnoAnonymousFieldDefinition {

  public GnoAnonymousFieldDefinitionImpl(GnoAnonymousFieldDefinitionStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoAnonymousFieldDefinitionImpl(ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getIdentifier() {
    return GnoPsiImplUtil.getIdentifier(this);
  }
  ...
  public GnoTypeReferenceExpression getTypeReferenceExpression() {
    return GnoPsiImplUtil.getTypeReferenceExpression(this);
  }
