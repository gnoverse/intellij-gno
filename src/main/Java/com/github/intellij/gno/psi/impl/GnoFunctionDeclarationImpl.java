...
public class GnoFunctionDeclarationImpl extends ASTWrapperPsiElement implements GnoFunctionDeclaration {

  public GnoFunctionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
