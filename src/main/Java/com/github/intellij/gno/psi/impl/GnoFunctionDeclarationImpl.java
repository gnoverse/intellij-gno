...
public class GnoFunctionDeclarationImpl extends GnoFunctionOrMethodDeclarationImpl<GnoFunctionDeclarationStub> implements GnoFunctionDeclaration {

  public GnoFunctionDeclarationImpl(GnoFunctionDeclarationStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoFunctionDeclarationImpl(ASTNode node) {
    super(node);
  }
