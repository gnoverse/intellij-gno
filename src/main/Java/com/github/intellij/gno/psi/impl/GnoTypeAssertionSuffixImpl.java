...
public class GnoTypeAssertionSuffixImpl extends ASTWrapperPsiElement implements GnoTypeAssertionSuffix {

  public GnoTypeAssertionSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GnoVisitor visitor) {
    visitor.visitTypeAssertionSuffix(this);
  }
