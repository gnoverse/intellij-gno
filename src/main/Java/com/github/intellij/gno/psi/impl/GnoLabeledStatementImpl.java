...
public class GnoLabeledStatementImpl extends GnoStatementImpl implements GnoLabeledStatement {

  public GnoLabeledStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GnoLabelDefinition getLabelDefinition() {
    return notNullChild(GnoPsiTreeUtil.getChildOfType(this, GnoLabelDefinition.class));
  }
