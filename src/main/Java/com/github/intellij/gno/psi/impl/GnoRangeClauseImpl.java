...
public class GnoRangeClauseImpl extends GnoVarSpecImpl implements GnoRangeClause {

  public GnoRangeClauseImpl(GnoVarSpecStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoRangeClauseImpl(ASTNode node) {
    super(node);
  }
  ...
  @Nullable
  public GnoExpression getRangeExpression() {
    return GnoPsiImplUtil.getRangeExpression(this);
  }
