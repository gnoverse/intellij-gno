...
public class GnoShortVarDeclarationImpl extends ASTWrapperPsiElement implements GnoShortVarDeclaration {

  public GnoShortVarDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GnoVarDefinitionList getVarDefinitionList() {
    return findNotNullChildByClass(GnoVarDefinitionList.class);
  }
