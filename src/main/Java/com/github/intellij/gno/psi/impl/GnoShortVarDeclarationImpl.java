...
public class GnoShortVarDeclarationImpl extends GnoVarSpecImpl implements GnoShortVarDeclaration {

  public GnoShortVarDeclarationImpl(GnoVarSpecStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }

  public GnoShortVarDeclarationImpl(ASTNode node) {
    super(node);
  }
