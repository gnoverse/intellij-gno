...
import com.github.intellij.gno.project.GoModuleSettings;
import com.github.intellij.gno.runconfig.GoConsoleFilter;
...
public class GoExecutor {
  ...
  public boolean execute() {
    ...
    try {
      ...
      myProcessHandler = new OSProcessHandler(finalCommandLine) {
        @Override
...
//      CapturingProcessAdapter processAdapter = new CapturingProcessAdapter(myProicessOutput) {
//        @Override
