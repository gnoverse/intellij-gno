...
public class GnoPathResolveScope extends GlobalSearchScope {
  @Nullable private final VirtualFile myReferenceFile;
  @NotNull private final GnoPathScopeHelper myScopeHelper;
  ...
  public static GlobalSearchScope create(@NotNull Project project, @Nullable Module module, @Nullable PsiElement context) {
    ...
    return new GnoPathResolveScope(project, referenceFile, GnoPathScopeHelper.fromReferenceFile(project, module, referenceFile));
  }

  private GnoPathResolveScope(@NotNull Project project,
                             @Nullable VirtualFile referenceFile,
                             @NotNull GnoPathScopeHelper scopeHelper) {
    super(project);
