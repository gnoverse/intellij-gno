...
import com.github.intellij.gno.psi.GoCompositeElementType;
import com.github.intellij.gno.stubs.GoElementTypeFactory;
import com.github.intellij.gno.psi.GoTokenType;
...
public interface GoTypes {
    ...
    IElementType GO = new GoTokenType("gno");
